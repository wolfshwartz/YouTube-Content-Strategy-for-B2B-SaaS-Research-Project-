...
### 2. Austin Schneider's "repurpose those videos and make them my own"
...
**Why not.** Three reasons, in increasing order of seriousness. First, relevance: YouTube is item 4 of 12 in his video, and his treatment of it is roughly two minutes of general encouragement, so the topical yield is thin. Second, an internal factual inconsistency: within one segment he cites 64% of executives using Meta and then 68% of executives using it, and none of his statistics carry a named source beyond one attribution to Salesforce (source: Austin Schneider, YouTube, 18.04.2025). Third, and decisively, the copy-your-competitors advice discussed above, which I would not want a junior marketer to adopt uncritically.
